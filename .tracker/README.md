...
| [0010](./issues/0010.md) | Realtime authorization: gating Hocuspocus connections & doc loads | `grilling` | open | 0004 |

## Frontier (open, unblocked, unclaimed)

- **0003** Data model *(newly unblocked by 0002 — high leverage)*
- **0004** Real-time layer *(research findings landed; needs decision recording)*
- **0005** Block editor scope
- **0006** Auth: library choice
- **0007** Attachments *(newly unblocked by 0002)*
- **0009** Monorepo & project structure

> 0008 waits on 0003; 0010 waits on 0004. They leave the frontier as those close.
